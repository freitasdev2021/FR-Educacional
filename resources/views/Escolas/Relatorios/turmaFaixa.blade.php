            ...
            <form action="{{route('Escolas/Relatorios/Gerar',$Tipo)}}" method="POST">
                ...
                <div class="col-sm-12 p-2">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Serie" name="Conteudo[]" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                          Serie
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="QTSerie" name="Conteudo[]" id="flexCheckChecked">
