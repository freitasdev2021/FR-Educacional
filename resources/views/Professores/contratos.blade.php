    ...
    <div class="fr-card p-0 shadow col-sm-12">
        ...
        <div class="fr-card-body">
            ...
            <div class="col-sm-12 p-2 row">
                <div class="col-auto">
                    <a href="{{route('Professores/Contratos/Novo')}}" class="btn btn-fr">Adicionar</a>
                </div>
            </div>
            <!--LISTAS-->
            <div class="col-sm-12 p-2">
                <hr>
                <table class="table table-sm tabela" id="escolas" data-rota="{{route('Professores/Contratos/list')}}">
                    <thead>
                      <tr>
