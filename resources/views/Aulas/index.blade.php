    ...
    <div class="fr-card p-0 shadow col-sm-12">
        ...
        <div class="fr-card-body">
            ...
            <div class="col-sm-12 p-2">
                <table class="table table-sm tabela" id="escolas" data-rota="{{ route('Aulas/list') }}{{ isset($_GET['IDTurma']) && !empty($_GET['IDTurma']) ? '?IDTurma=' . $_GET['IDTurma'] : '' }}{{ isset($_GET['Estagio']) && !empty($_GET['Estagio']) ? (isset($_GET['IDTurma']) && !empty($_GET['IDTurma']) ? '&' : '?') . 'Estagio=' . $_GET['Estagio'] : '' }}">
                    <thead>
                      <tr>
