    ...
    <div class="fr-card p-0 shadow col-sm-12">
       ...
       <div class="fr-card-body">
          ...
          <div class="col-sm-12 p-2 row">
             <div class="col-auto">
                <a class="btn btn-fr" href="{{route('Calendario/Planejamentos/Novo')}}">Adicionar</a>
             </div>
          </div>
          <hr>
          @endif
          ...
          <div class="col-sm-12 p-2 ">
            <table class="table table-sm tabela" id="escolas" data-rota="{{route('Calendario/Planejamentos/list')}}">
              <thead>
                <tr>
