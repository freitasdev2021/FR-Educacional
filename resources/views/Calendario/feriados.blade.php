    ...
    <div class="fr-card p-0 shadow col-sm-12">
       ...
       <div class="fr-card-body">
          ...
          <div class="col-sm-12 p-2 row">
             <div class="col-auto">
                <a class="btn btn-fr" href="{{route('Calendario/Feriados/Novo')}}">Adicionar</a>
             </div>
          </div>
          <hr>
          @endif
          ...
          <div class="col-sm-12 p-2 ">
            <table class="table table-sm tabela" id="escolas" data-rota="{{route('Calendario/Feriados/list')}}">
              <thead>
                <tr>
                  @if(in_array(Auth::user()->tipo,[2,2.5]))<th style="text-align:center;" scope="col">Escola</th>@endif
                  <th style="text-align:center;" scope="col">Feriado</th>
