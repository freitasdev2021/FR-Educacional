<x-educacional-layout>
    <div class="fr-card p-0 shadow col-sm-12">
       ...
       <div class="fr-card-body">
          <form action="{{route('Calendario/Planejamentos/Save')}}" method="POST">
             @csrf
             @if(session('success'))
             ...
             <div class="col-sm-12 p-2">
                ...
                <div class="row">
                  <div class="col-sm-12">
                     <label>Assunto</label>
                     <input class="form-control" name="Assunto" value="{{isset($Registro) ? $Registro->Assunto : ''}}">
                  </div>
                </div>
                <br>
                <div class="row">
                   ...
                   <div class="col-auto">
                      <a class="btn btn-light" href="{{route('Calendario/Planejamentos')}}">Cancelar</a>
                   </div>
                </div>
             </div>
          </form>
