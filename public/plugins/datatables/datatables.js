...
!(function (n) {
    ...
    var C,
                      ...
                      if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                          ...
                          var u = V.extend(!0, {}, $.models.oSettings, {
                              ...
                              t =
                                  ...
                                  nt(n),
                                  n.aLengthMenu && !n.iDisplayLength && (n.iDisplayLength = Array.isArray(n.aLengthMenu[0]) ? n.aLengthMenu[0][0] : V.isPlainObject(n.aLengthMenu[0]) ? n.aLengthMenu[0].value : n.aLengthMenu[0]),
                                  (n = Zt(V.extend(!0, {}, e), n)),
                              ...
                              c =
                                  ($.__browser ||
                                      ...
                                      ($.__browser = P),
                                      (j = V("<div/>")
                                          .css({ position: "fixed", top: 0, left: -1 * q.pageXOffset, height: 1, width: 1, overflow: "hidden" })
                                          .append(
                                              V("<div/>")
                                                  .css({ position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll" })
                                                  .append(V("<div/>").css({ width: "100%", height: 10 }))
                                          )
                                          .appendTo("body")),
                                      (p = j.children()),
                                      (O = p.children()),
                              ...
                              d =
                                  ...
                                  void 0 === u.iInitDisplayStart && ((u.iInitDisplayStart = n.iDisplayStart), (u._iDisplayStart = n.iDisplayStart)),
                                  u.oLanguage),
                              f =
                          ...
                          else if (p.length) for (l = p[(a = 0)].length; a < l; a++) f.push(null);
                          ...
                          var g,
                              ...
                              C = S.aoColumns;
                          if (w) for (g = 0, v = w.length; g < v; g++) w[g] && w[g].name && (C[g].sName = w[g].name);
                          if (T)
                          ...
                          var L,
                                          ...
                                          .each(function (t, e) {
                                              ...
                                              a || Z(u, 0, "Incorrect column count", 18),
                                                  a.mData === t &&
                                                      ...
                                                      (null === n && null === e) ||
                                                          ((a.mData = { _: t + ".display", sort: null !== n ? t + ".@data-" + n : void 0, type: null !== n ? t + ".@data-" + n : void 0, filter: null !== e ? t + ".@data-" + e : void 0 }),
                                                          (a._isArrayHost = !0),
                                                          ot(u, t)));
                                          })),
                                  u.oFeatures),
                              O = function () {
                                  ...
                                  var e = o.children("caption"),
                                      e =
                                          (u.caption && (e = 0 === e.length ? V("<caption/>").appendTo(o) : e).html(u.caption),
                                          e.length && ((e[0]._captionSide = e.css("caption-side")), (u.captionNode = e[0])),
                                  ...
                                  if ((0 === e.length && (e = V("<tfoot/>").appendTo(o)), (u.nTFoot = e[0]), V("tr", e).addClass(c.tfoot.row), n.aaData)) for (a = 0; a < n.aaData.length; a++) Y(u, n.aaData[a]);
                              ...
                              n.bStateSave
                                  ? ((R.bStateSave = !0),
                                    ...
                                    (F = u).oFeatures.bStateSave
                                        ? void 0 !==
                                              (j = F.fnStateLoadCallback.call(F.oInstance, F, function (t) {
                                                  Jt(F, t, N);
                                              })) && Jt(F, j, N)
                                        : N())
                                  : O();
        ...
        c =
            ...
            V.extend(C, { afnFiltering: C.search, aTypes: C.type.detect, ofnSearch: C.type.search, oSort: C.type.order, afnSortData: C.order, aoFeatures: C.feature, oStdClasses: C.classes, oPagination: C.pager }),
            V.extend($.ext.classes, {
                container: "dt-container",
                empty: { row: "dt-empty" },
                info: { container: "dt-info" },
                length: { container: "dt-length", select: "dt-input" },
                order: { canAsc: "dt-orderable-asc", canDesc: "dt-orderable-desc", isAsc: "dt-ordering-asc", isDesc: "dt-ordering-desc", none: "dt-orderable-none", position: "sorting_" },
                processing: { container: "dt-processing" },
                scrolling: { body: "dt-scroll-body", container: "dt-scroll", footer: { self: "dt-scroll-foot", inner: "dt-scroll-footInner" }, header: { self: "dt-scroll-head", inner: "dt-scroll-headInner" } },
                ...
                : ((f = function (t, e, n) {
                      for (var a, r, o, i, l = ft(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
                          ...
                          if (((a = l[s].match(dt)), (r = l[s].match(p)), a)) {
                              if (((l[s] = l[s].replace(dt, "")), (t[l[s]] = []), (a = l.slice()).splice(0, s + 1), (i = a.join(".")), Array.isArray(e))) for (var c = 0, d = e.length; c < d; c++) f((o = {}), e[c], i), t[l[s]].push(o);
                              else t[l[s]] = e;
                              return;
                          }
    ...
    function rt(t) {
        var e = $.defaults.column,
            ...
            e = V.extend({}, $.models.oColumn, e, { aDataSort: e.aDataSort || [n], mData: e.mData || n, idx: n, searchFixed: {}, colEl: V("<col>").attr("data-dt-column", n) }),
    ...
    function ot(t, e, n) {
        ...
        (r._bAttrSrc = V.isPlainObject(o) && (a(o.sort) || a(o.type) || a(o.filter))),
            (r._setter = null),
    ...
    function M(t) {
        ...
        if (e.oFeatures.bAutoWidth) {
            ...
            for (
                f.append(V(e.nTHead).clone()).append(V(e.nTFoot).clone()),
                    ...
                    f.find("thead th, thead td").each(function () {
                        var t = lt(e, this, !0, !1);
                        t ? ((this.style.width = t), s && V(this).append(V("<div/>").css({ width: t, margin: 0, padding: 0, border: 0, height: 1 }))) : (this.style.width = "");
                    }),
                    n = 0;
                n < u.length;
                n++
            ...
            var m = V("<div/>")
                    .css(s || l ? { position: "absolute", top: 0, left: 0, height: 1, right: 0, overflow: "hidden" } : {})
                    .append(f)
                    .appendTo(d),
    ...
    function B(t) {
        for (var e, n, a, r, o, i, l, s = t.aoColumns, u = t.aoData, c = $.ext.type.detect, d = 0, f = s.length; d < f; d++) {
            ...
            if (h && !o._render) {
                ...
                for (var p, g = t, v = d, m = g.aoData, b = 0; b < m.length; b++) m[b].nTr && ((p = G(g, b, v, "display")), (m[b].displayData[v] = p), ct(m[b].anCells[v], p));
            }
        }
    }
    function it(t, e, n) {
    ...
    function Y(t, e, n, a) {
        for (var r = t.aoData.length, o = V.extend(!0, {}, $.models.oRow, { src: n ? "dom" : "data", idx: r }), i = ((o._aData = e), t.aoData.push(o), t.aoColumns), l = 0, s = i.length; l < s; l++) i[l].sType = null;
    ...
    function G(t, e, n, a) {
        ...
        if (r) {
            ...
            if (void 0 === (s = "display" !== a && s && "object" == typeof s && s.nodeName ? s.innerHTML : s))
                return t.iDrawError != o && null === l && (Z(t, 0, "Requested unknown parameter " + ("function" == typeof i.mData ? "{function}" : "'" + i.mData + "'") + " for row " + e + ", column " + n, 4), (t.iDrawError = o)), l;
    ...
    function vt(t, e, n, a) {
        function r(t, e) {
            var n;
            "string" == typeof t && -1 !== (n = t.indexOf("@")) && ((n = t.substring(n + 1)), v(t)(a, e.getAttribute(n)));
        }
        function o(t) {
            (void 0 !== n && n !== d) ||
                ((l = f[d]), (s = t.innerHTML.trim()), l && l._bAttrSrc ? (v(l.mData._)(a, s), r(l.mData.sort, t), r(l.mData.type, t), r(l.mData.filter, t)) : h ? (l._setter || (l._setter = v(l.mData)), l._setter(a, s)) : (a[d] = s)),
                d++;
        }
        var i,
            l,
        ...
        return e && (e = e.getAttribute("id")) && v(t.rowId)(a, e), { data: a, cells: u };
    }
    function mt(t, e) {
        var n = t.aoData[e],
            a = t.aoColumns;
    ...
    function bt(t, e, n, a) {
        ...
        if (null === c.nTr) {
            for (r = n || _.createElement("tr"), c.nTr = r, c.anCells = f, D(r, h), r._DT_RowIndex = e, yt(t, c), l = 0, s = t.aoColumns.length; l < s; l++) {
                (i = t.aoColumns[l]), (o = (u = !n || !a[l]) ? _.createElement(i.sCellType) : a[l]) || Z(t, 0, "Incorrect column count", 18), (o._DT_CellIndex = { row: e, column: l }), f.push(o);
                var p = mt(t, e);
                (!u && ((!i.mRender && i.mData === l) || (V.isPlainObject(i.mData) && i.mData._ === l + ".display"))) || ct(o, p[l]),
                    i.bVisible && u ? r.appendChild(o) : i.bVisible || u || o.parentNode.removeChild(o),
                    i.fnCreatedCell && i.fnCreatedCell.call(t.oInstance, o, G(t, e, l), d, e, l);
            }
    ...
    function yt(t, e) {
        ...
        n &&
            ...
            a.DT_RowClass && ((t = a.DT_RowClass.split(" ")), (e.__rowc = e.__rowc ? x(e.__rowc.concat(t)) : t), V(n).removeClass(e.__rowc.join(" ")).addClass(a.DT_RowClass)),
    ...
    function Dt(t, e) {
        var n,
            ...
            i = "header" === e ? "sTitle" : e;
        if (o) {
            if (("header" === e || f(t.aoColumns, i).join("")) && 1 === (n = (n = V("tr", o)).length ? n : V("<tr/>").appendTo(o)).length)
    ...
    function S(t, e) {
        if (
            ((r = "ssp" == et((s = t))),
            void 0 !== (i = s.iInitDisplayStart) && -1 !== i && ((s._iDisplayStart = !r && i >= s.fnRecordsDisplay() ? 0 : i), (s.iInitDisplayStart = -1)),
            ...
            if (0 !== o.length)
                for (var d = r ? t.aoData.length : s, f = r ? 0 : i; f < d; f++) {
                    for (var h = o[f], p = t.aoData[h], g = (null === p.nTr && bt(t, h), p.nTr), v = 0; v < u.length; v++) {
                        var m = u[v],
                            b = p.anCells[v];
                        D(b, C.type.className[m.sType]), D(b, m.sClass), D(b, t.oClasses.tbody.cell);
                    }
                    tt(t, "aoRowCallback", null, [g, p._aData, a, f, h]), n.push(g), a++;
                }
            else n[0] = Tt(t);
            tt(t, "aoHeaderCallback", "header", [V(t.nTHead).children("tr")[0], ht(t), i, s, o]),
                tt(t, "aoFooterCallback", "footer", [V(t.nTFoot).children("tr")[0], ht(t), i, s, o]),
                c[0].replaceChildren ? c[0].replaceChildren.apply(c[0], n) : (c.children().detach(), c.append(V(n))),
                V(t.nTableWrapper).toggleClass("dt-empty-footer", 0 === V("tr", t.nTFoot).length),
    ...
    function Tt(t) {
        var e = t.oLanguage,
            ...
            a = et(t);
        return (
            (t.iDraw < 1 && "ssp" === a) || (t.iDraw <= 1 && "ajax" === a) ? (n = e.sLoadingRecords) : e.sEmptyTable && 0 === t.fnRecordsTotal() && (n = e.sEmptyTable),
            V("<tr/>").append(V("<td />", { colSpan: W(t), class: t.oClasses.empty.row }).html(n))[0]
        );
    }
    function wt(t, e, n) {
        for (
                ...
                a =
                    (V.each(e, function (t, e) {
                        if (null !== e) {
                            ...
                            if (((a[n] && a[n].contents) || (a[n] = { contents: [] }), Array.isArray(e))) for (var o = 0; o < e.length; o++) r(a[n].contents, e[o]);
            ...
            a[o].val.full && (r.push({ full: a[o].val.full }), _t(t, r[r.length - 1]), delete a[o].val.full), Object.keys(a[o].val).length && (r.push(a[o].val), _t(t, r[r.length - 1]));
        return r;
    }
    function _t(o, i) {
        function l(t, e) {
            ...
            for (var e, n = i[t].contents, a = 0, r = n.length; a < r; a++)
                n[a] &&
                    ("string" == typeof n[a]
                        ...
                        ? (n[a] = n[a].node(o))
                        : "function" == typeof n[a] && ((e = n[a](o)), (n[a] = "function" == typeof e.node ? e.node() : e)));
        });
    }
    function Ct(e) {
        var a,
        ...
        if (((e.nTableWrapper = r[0]), e.sDom))
            for (var o, i, l, s, u, c, d = e, t = e.sDom, f = r, h = t.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++)
                (o = null),
                    "<" == (i = h[p])
                        ? ((l = V("<div/>")),
                          ("'" != (s = h[p + 1])[0] && '"' != s[0]) ||
                              ((s = s.replace(/['"]/g, "")), (u = ""), -1 != s.indexOf(".") ? ((c = s.split(".")), (u = c[0]), (c = c[1])) : "#" == s[0] ? (u = s) : (c = s), l.attr("id", u.substring(1)).addClass(c), p++),
                          f.append(l),
                          (f = l))
                        : ">" == i
                        ? (f = f.parent())
        ...
        n.oFeatures.bProcessing &&
            ((a = V("<div/>", { id: n.sTableId + "_processing", class: n.oClasses.processing.container, role: "status" })
                        ...
                        b = (b = +r.getAttribute("colspan")) && 0 != b && 1 != b ? b : 1,
                            ...
                            n &&
                                (s &&
                                    ...
                                    d ? (null === g.sTitle || g.autoTitle || (r.innerHTML = g.sTitle), !g.sTitle && s && ((g.sTitle = I(r.innerHTML)), (g.autoTitle = !0))) : g.footer && (r.innerHTML = g.footer),
                                    g.ariaTitle || (g.ariaTitle = V(r).attr("aria-label") || g.sTitle),
                                    g.className) &&
                                    V(r).addClass(g.className),
                                0 === V("span.dt-column-title", r).length && V("<span>").addClass("dt-column-title").append(r.childNodes).appendTo(r),
                                d) &&
    ...
    function At(n, t, a) {
        ...
        var r,
            ...
            i = n.oInstance,
            l =
                (V.isPlainObject(o) && o.data && ((l = "function" == typeof (r = o.data) ? r(t, n) : r), (t = "function" == typeof r && l ? l : V.extend(!0, t, l)), delete o.data),
                {
        ...
        V.isPlainObject(o) && V.extend(l, o),
            ...
            "function" == typeof o ? (n.jqXHR = o.call(i, t, e, n)) : "" === o.url ? ((i = {}), $.util.set(o.dataSrc)(i, []), e(i)) : ((n.jqXHR = V.ajax(l)), r && (o.data = r));
    }
    function Lt(t, e, n) {
        var a = "data";
        if ((V.isPlainObject(t.ajax) && void 0 !== t.ajax.dataSrc && ("string" == typeof (t = t.ajax.dataSrc) || "function" == typeof t ? (a = t) : void 0 !== t.data && (a = t.data)), !n))
    ...
    function Nt(n, t) {
        ...
        if ((B(n), "ssp" != et(n))) {
                ...
                if (c[d] && !(l = c[d])._aFilterData) {
                    for (o = [], a = 0, r = u.length; a < r; a++)
                        u[a].bSearchable ? "string" != typeof (i = null === (i = G(s, d, a, "filter")) ? "" : i) && i.toString && (i = i.toString()) : (i = ""),
                            i.indexOf && -1 !== i.indexOf("&") && ((Rt.innerHTML = i), (i = Ot ? Rt.textContent : Rt.innerText)),
            ...
            for (var p, g, v = n, m = $.ext.search, b = v.aiDisplay, y = 0, D = m.length; y < D; y++) {
                for (var x = [], S = 0, T = b.length; S < T; S++) (g = b[S]), (p = v.aoData[g]), m[y](v, p._aFilterData, g, p._aData, S) && x.push(g);
                ...
                var o = 0,
                    ...
                    s =
                        n instanceof RegExp
                            ...
                            : (function (t, e) {
                                  var a = [],
                                      e = V.extend({}, { boundary: !1, caseInsensitive: !0, exact: !1, regex: !1, smart: !0 }, e);
                                  ...
                                  if (((t = O(t)), e.exact)) return new RegExp("^" + Pt(t) + "$", e.caseInsensitive ? "i" : "");
                                  {
                                      ...
                                      (t = e.regex ? t : Pt(t)),
                                          e.smart &&
                                              ((n = (t.match(/!?["\u201C][^"\u201D]+["\u201D]|[^ ]+/g) || [""]).map(function (t) {
                                                  var e,
                                                      n = !1;
                                                  return (
                                                      "!" === t.charAt(0) && ((n = !0), (t = t.substring(1))),
                                                      '"' === t.charAt(0) ? (t = (e = t.match(/^"(.*)"$/)) ? e[1] : t) : "“" === t.charAt(0) && (t = (e = t.match(/^\u201C(.*)\u201D$/)) ? e[1] : t),
                                                      n && (1 < t.length && a.push("(?!" + t + ")"), (t = "")),
                                                      t.replace(/"/g, "")
                                                  );
                                              })),
                                              (r = a.length ? a.join("") : ""),
    ...
    function Et(n) {
        ...
        n.bInitialised
            ? (Dt(n, "header"),
              ...
              Vt(t, e, e === t.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o),
              Ut(t, (r = []), t.aaSorting),
              (t.aaSorting = r),
              Bt(n),
              w(n, !0),
              ...
              (u = V((s = "<div/>"), { class: a.container })
                  .append(
                      V(s, { class: a.header.self })
                          .css({ overflow: "hidden", position: "relative", border: 0, width: e ? c(e) : "100%" })
                          .append(
    ...
    function Xt(e) {
        ...
        if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis) (e.scrollBarVis = f), M(e);
        else {
            if (
                ((e.scrollBarVis = f),
            ...
            a.css("width", A(v)),
                ...
                c && (l.css("width", A(v)), i.css("width", A(v)).css(f, s ? t + "px" : "0px")),
                            ...
                            (function (t, e, n, a) {
                                ...
                                (a || n) && t.oFeatures.bSortMulti
                                    ? -1 !== (i = f(l, "0").indexOf(e))
                                        ...
                                        : (a ? l.push([e, s[0], 0]) : l.push([e, l[0][1], 0]), (l[l.length - 1]._idx = 0))
                                    : l.length && l[0][0] == e
    ...
    function $t(t) {
        ...
        if (t.oFeatures.bSort)
            for (Array.isArray(d) && Ut(t, h, d), f && d.pre && Ut(t, h, d.pre), Ut(t, h, t.aaSorting), f && d.post && Ut(t, h, d.post), e = 0; e < h.length; e++)
                if (c[(l = h[e][0])])
                    for (n = 0, a = (r = c[l].aDataSort).length; n < a; n++)
                        (i = c[(o = r[n])].sType || "string"),
                            void 0 === h[e]._idx && (h[e]._idx = c[o].asSorting.indexOf(h[e][1])),
                            h[e][1] && s.push({ src: l, col: o, dir: h[e][1], index: h[e]._idx, type: i, formatter: u[i + "-pre"], sorter: u[i + "-" + h[e][1]] });
        return s;
    }
    function zt(t, e, n) {
        var a,
            ...
            u = t.aiDisplayMaster;
        for (
            B(t), void 0 !== e ? ((l = t.aoColumns[e]), (c = [{ src: e, col: e, dir: n, index: 0, type: l.sType, formatter: s[l.sType + "-pre"], sorter: s[l.sType + "-" + n] }]), (u = u.slice())) : (c = $t(t)), a = 0, r = c.length;
            a < r;
            a++
        ) {
            ...
            for (var D = $.ext.type.order[b.sType + "-pre"], x = v.aoData, S = 0; S < x.length; S++)
                x[S] && ((p = x[S])._aSortData || (p._aSortData = []), (p._aSortData[m] && !y) || ((g = y ? h[S] : G(v, S, m, "sort")), (p._aSortData[m] = D ? D(g, v) : g)));
        }
        if ("ssp" != et(t) && 0 !== c.length) {
            for (a = 0, o = u.length; a < o; a++) d[a] = a;
            c.length && "desc" === c[0].dir && d.reverse(),
                u.sort(function (t, e) {
                    for (var n, a, r, o, i = c.length, l = f[t]._aSortData, s = f[e]._aSortData, u = 0; u < i; u++)
    ...
    function Jt(n, t, e) {
        ...
        if (t && t.time) {
            ...
            else if (-1 !== tt(n, "aoStateLoadParams", "stateLoadParams", [n, t]).indexOf(!1)) n._bLoadingState = !1;
            else if (t.columns && o.length !== t.columns.length) n._bLoadingState = !1;
            else {
                if (
                    ((n.oLoadedState = V.extend(!0, {}, t)),
                    tt(n, null, "stateLoadInit", [n, t], !0),
                    void 0 !== t.length && (i ? i.page.len(t.length) : (n._iDisplayLength = t.length)),
                    void 0 !== t.start && (null === i ? ((n._iDisplayStart = t.start), (n.iInitDisplayStart = t.start)) : Ht(n, t.start / n._iDisplayLength)),
                    void 0 !== t.order &&
                        ((n.aaSorting = []),
    ...
    function Z(t, e, n, a) {
        if (((n = "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + n), a && (n += ". For more information about this error, please see https://datatables.net/tn/" + a), e)) q.console && console.log && console.log(n);
        else {
    ...
    function Zt(t, e, n) {
        ...
        for (r in e)
            Object.prototype.hasOwnProperty.call(e, r) &&
                ((a = e[r]), V.isPlainObject(a) ? (V.isPlainObject(t[r]) || (t[r] = {}), V.extend(!0, t[r], a)) : n && "data" !== r && "aaData" !== r && Array.isArray(a) ? (t[r] = a.slice()) : (t[r] = a));
        return t;
    }
    function Qt(t, e, n) {
        V(t)
    ...
    function tt(e, t, n, a, r) {
        ...
        return (
            ...
            null !== n && ((t = V.Event(n + ".dt")), (n = V(e.nTable)), (t.dt = e.api), n[r ? "trigger" : "triggerHandler"](t, a), r && 0 === n.parents("body").length && V("body").trigger(t, a), o.push(t.result)),
            o
        );
    }
    function Kt(t) {
    ...
    (U = function (t, e) {
            ...
            var n,
                ...
                r = t
                    ? t.nTable && t.oFeatures
                        ...
                        ? t.settings().toArray()
                        : ("string" == typeof t ? (n = V(t).get()) : t instanceof V && (n = t.get()),
                          n
        ...
        (this.context = 1 < o.length ? x(o) : o), e && this.push.apply(this, e), (this.selector = { rows: null, cols: null, opts: null }), U.extend(this, this, ne);
    }),
        ($.Api = U),
        V.extend(U.prototype, {
            ...
            iterator: function (t, e, n, a) {
                ...
                for ("string" == typeof t && ((a = n), (n = e), (e = t), (t = !1)), o = 0, i = h.length; o < i; o++) {
                    ...
                    else if ("columns" === e || "rows" === e) void 0 !== (r = n.call(g, h[o], this[o], o)) && f.push(r);
                    else if ("every" === e || "column" === e || "column-rows" === e || "row" === e || "cell" === e)
                        for (c = this[o], "column-rows" === e && (u = he(h[o], p.opts)), l = 0, s = c.length; l < s; l++)
                            (d = c[l]), void 0 !== (r = "cell" === e ? n.call(g, h[o], d.row, d.column, o, l) : n.call(g, h[o], d, o, l, u)) && f.push(r);
                }
        ...
        (U.register = e = function (t, e) {
            if (Array.isArray(t)) for (var n = 0, a = t.length; n < a; n++) U.register(t[n], e);
            else
    ...
    function oe(t, e, n, a, r) {
        for (var o, i, l, s, u = [], c = typeof e, d = 0, f = (e = e && "string" != c && "function" != c && void 0 !== e.length ? e : [e]).length; d < f; d++)
            for (l = 0, s = (i = e[d] && e[d].split && !e[d].match(/[[(:]/) ? e[d].split(",") : [e[d]]).length; l < s; l++)
                (o = (o = n("string" == typeof i[l] ? i[l].trim() : i[l])).filter(function (t) {
                    return null != t;
                })) &&
                    o.length &&
                    (u = u.concat(o));
    ...
    function ie(t) {
        return (t = t || {}).filter && void 0 === t.search && (t.search = t.filter), V.extend({ search: "none", order: "current", page: "all" }, t);
    }
    function le(t) {
                ...
                : this.iterator(
                      ...
                      function (t) {
                          var e = V(t.nTable),
                              n = V(t.captionNode),
                              a = V(t.nTableWrapper);
                          n.length || ((n = V("<caption/>").html(r)), (t.captionNode = n[0]), o) || (e.prepend(n), (o = n.css("caption-side"))),
                              n.html(r),
                              o && (n.css("caption-side", o), (n[0]._captionSide = o)),
                              (a.find("div.dataTables_scroll").length ? ((t = "top" === o ? "Head" : "Foot"), a.find("div.dataTables_scroll" + t + " table")) : e).prepend(n);
                      },
                      1
                  );
        }),
        ...
        e("page.info()", function () {
            ...
            if (0 !== this.context.length)
                return (
                    ...
                    { page: (r = -1 === n) ? 0 : Math.floor(e / n), pages: r ? 1 : Math.ceil(a / n), start: e, end: t.fnDisplayEnd(), length: n, recordsTotal: t.fnRecordsTotal(), recordsDisplay: a, serverSide: "ssp" === et(t) }
                );
        }),
    ...
    function se(o, i, t, e) {
        function l(t, e) {
            var n;
            if (Array.isArray(t) || t instanceof V) for (var a = 0, r = t.length; a < r; a++) l(t[a], e);
            else
                t.nodeName && "tr" === t.nodeName.toLowerCase()
                    ? (t.setAttribute("data-dt-row", i.idx), s.push(t))
                    : ((n = V("<tr><td></td></tr>").attr("data-dt-row", i.idx).addClass(e)), (V("td", n).addClass(e).html(t)[0].colSpan = W(o)), s.push(n[0]));
        }
        var s = [];
        ...
        if (n.length && t.length) {
            ...
            if (a._details) {
                ...
                if ((r.off(e + " " + t + " " + a), f(l, "_details").length > 0)) {
                    ...
                    r.on(a, function (t, e) {
                        if (i !== e) return;
                        for (var n = 0, a = l.length; n < a; n++) if (l[n] && l[n]._details) ve(r, n);
                    });
                }
                ge(n);
            }
    ...
    var he = function (t, e) {
            var n,
                ...
                i = e.search,
                l = e.order;
            if ("current" == e.page) for (u = t._iDisplayStart, c = t.fnDisplayEnd(); u < c; u++) a.push(r[u]);
            ...
            } else if ("index" == l || "original" == l) for (u = 0, c = t.aoData.length; u < c; u++) t.aoData[u] && ("none" == i || (-1 === (n = r.indexOf(u)) && "removed" == i) || (0 <= n && "applied" == i)) && a.push(u);
            else if ("number" == typeof l) {
                var d = zt(t, l, "asc");
                if ("none" === i) a = d;
                else for (u = 0; u < d.length; u++) ((-1 === (n = r.indexOf(d[u])) && "removed" == i) || (0 <= n && "applied" == i)) && a.push(d[u]);
            }
            return a;
        },
        pe =
                                ...
                                function (n) {
                                    ...
                                    if (n.nodeName)
                                        return (
                                            (t = n._DT_RowIndex),
                                            (e = n._DT_CellIndex),
                                            void 0 !== t ? (a[t] && a[t].nTr === n ? [t] : []) : e ? (a[e.row] && a[e.row].nTr === n.parentNode ? [e.row] : []) : (t = V(n).closest("*[data-dt-row]")).length ? [t.data("dt-row")] : []
                                        );
            ...
            e("row().data()", function (t) {
                ...
                return void 0 === t
                    ? n.length && this.length && this[0].length
                        ...
                        : void 0
                    : (((e = n[0].aoData[this[0]])._aData = t), Array.isArray(t) && e.nTr && e.nTr.id && v(n[0].rowId)(t, e.nTr.id), gt(n[0], this[0], "data"), this);
            }),
            e("row().node()", function () {
                var t = this.context;
            ...
            (e(be, function (t, e) {
                ...
                return void 0 === t
                    ? n.length && this.length && n[0].aoData[this[0]]
                        ...
                        : void 0
                    : (!0 === t ? this.child.show() : !1 === t ? ve(this) : n.length && this.length && se(n[0], n[0].aoData[this[0]], t, e), this);
            }),
        ...
        be =
                ...
                var e = this,
                    ...
                    t = this.iterator("column", function (t, e) {
                        ...
                        !(function (t, e, n) {
                            ...
                            if (n) for (var s = f(o, "bVisible").indexOf(!0, e + 1), u = 0, c = l.length; u < c; u++) l[u] && ((r = l[u].nTr), (a = l[u].anCells), r) && r.insertBefore(a[e], a[s] || null);
                ...
                return (
                    void 0 !== n &&
                        this.iterator("table", function (t) {
                            St(t, t.aoHeader),
                                St(t, t.aoFooter),
                                t.aiDisplay.length || V(t.nTBody).find("td[colspan]").attr("colspan", W(t)),
                                Gt(t),
            ...
            e("cells()", function (g, t, v) {
                var a, r, o, i, l, s, e;
                return (
                    V.isPlainObject(g) && (void 0 === g.row ? ((v = g), (g = null)) : ((v = t), (t = null))),
                                  ...
                                  oe(
                                      ...
                                      function (t) {
                                          var e,
                                              n = "function" == typeof t;
                                          if (null == t || n) {
                                              for (o = [], i = 0, l = f.length; i < l; i++) for (r = f[i], s = 0; s < p; s++) (u = { row: r, column: s }), (!n || ((c = d[r]), t(u, G(a, r, s), c.anCells ? c.anCells[s] : null))) && o.push(u);
                                              return o;
                                          }
                                          return V.isPlainObject(t)
                                              ? void 0 !== t.column && void 0 !== t.row && -1 !== f.indexOf(t.row)
                                                  ? [t]
                                                  : []
                                              : (e = h
                                                    .filter(t)
            ...
            e("cell().data()", function (t) {
                ...
                return void 0 === t
                    ? i.length && l.length
                        ...
                        : void 0
                    : ((e = i[0]), (n = l[0].row), (a = l[0].column), (r = e.aoColumns[a]), (o = e.aoData[n]._aData), r.fnSetData(o, t, { settings: e, row: n, col: a }), gt(i[0], l[0].row, "data", l[0].column), this);
            }),
            ...
            e("search()", function (e, n, a, r) {
                ...
                return void 0 === e
                    ...
                    : this.iterator("table", function (t) {
                          t.oFeatures.bFilter &&
                              Nt(t, "object" == typeof n ? V.extend(t.oPreviousSearch, n, { search: e }) : V.extend(t.oPreviousSearch, { search: e, regex: null !== n && n, smart: null === a || a, caseInsensitive: null === r || r }));
                      });
            }),
            ...
            t("columns().search()", "column().search()", function (a, r, o, i) {
                return this.iterator("column", function (t, e) {
                    ...
                    t.oFeatures.bFilter &&
                        ("object" == typeof r ? V.extend(n[e], r, { search: a }) : V.extend(n[e], { search: a, regex: null !== r && r, smart: null === o || o, caseInsensitive: null === i || i }), Nt(t, t.oPreviousSearch));
                });
            }),
                    ...
                    this.iterator("table", function (t) {
                        var e = t.oClasses,
                            ...
                            o =
                                ...
                                o && n != o.parentNode && (i.children("tfoot").detach(), i.append(o)),
                                t.colgroup.remove(),
                                (t.aaSorting = []),
                                (t.aaSortingFixed = []),
                                Yt(t),
                                V("th, td", r)
                                    .removeClass(u.canAsc + " " + u.canDesc + " " + u.isAsc + " " + u.isDesc)
                                    .css("width", ""),
                                a.children().detach(),
                                a.append(s),
            ...
            ($.settings = []),
            ($.models = {}),
            ($.models.oSearch = { caseInsensitive: !0, search: "", regex: !1, smart: !0, return: !1 }),
            ($.models.oRow = { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, src: null, idx: -1, displayData: null }),
            ($.models.oColumn = {
                idx: null,
                aDataSort: null,
                asSorting: null,
            ...
            ($.defaults = {
                ...
                oLanguage: {
                    ...
                    sInfoEmpty: "Exibindo 0 para 0 de 0 Registros",
            ...
            k($.defaults.column),
            ($.models.oSettings = {
                oFeatures: { bAutoWidth: null, bDeferRender: null, bFilter: null, bInfo: !0, bLengthChange: !0, bPaginate: null, bProcessing: null, bServerSide: null, bSort: null, bSortMulti: null, bSortClasses: null, bStateSave: null },
            ...
            pagingButton: {
                _: function (t, e, n, a, r) {
                    ...
                    return (
                        a && o.push(t.active),
                        r && o.push(t.disabled),
                        { display: (a = "ellipsis" === e ? V('<span class="ellipsis"></span>').html(n)[0] : V("<button>", { class: o.join(" "), role: "link", type: "button" }).html(n)), clicker: a }
                    );
                },
            },
            pagingContainer: {
        ...
        return function (a, r, o, i) {
            ...
            return (
                ...
                function (t, e) {
                    var n;
                    return (
                        null == t && (t = "--now" === i ? ((n = new Date()), new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds()))) : ""),
                        "type" === e
                            ? l
                            : "" === t
                            ? "sort" !== e
                            ...
                            : !(null === r || a !== r || "sort" === e || "type" === e || t instanceof Date) || null === (n = Te(t, a, o))
                            ? t
                            : "sort" === e
                            ? n
                            : ((t = null === r ? xe(n, "toDate", "toJSDate", "")[s]() : xe(n, "format", "toFormat", "toISOString", r)), "display" === e ? u(t) : t)
                    );
                }
            );
        };
            ...
            (($.type = function (a, t, e) {
                ...
                void 0 === e && ((e = t), (t = null)),
                    "className" === t
                        ...
                        : "search" === t
                        ? n("search", e)
                        : t || (e.className && n("className", e.className), void 0 !== e.detect && r(e.detect), e.order && o(e.order), void 0 !== e.render && n("render", e.render), void 0 !== e.search && n("search", e.search));
            }),
            ($.types = function () {
                ...
                "disable" === f.attr("data-dt-order") ||
                    ...
                    V(d.nTable).on("order.dt.DT", function (t, e, n) {
                        ...
                        d === e &&
                            ...
                            -1 !== (l = s.indexOf("," + u.toArray().join(",") + ",")) && ((s = c.order()), f.addClass(s.includes("asc") ? a.isAsc : "" + s.includes("desc") ? a.isDesc : "")),
                            0 === l ? ((u = n[0]), (c = r.asSorting), f.attr("aria-sort", "asc" === u.dir ? "ascending" : "descending"), (i = c[u.index + 1] ? "Reverse" : "Remove")) : f.removeAttr("aria-sort"),
                            f.attr("aria-label", o ? r.ariaTitle + e.api.i18n("oAria.orderable" + i) : r.ariaTitle),
                            o) &&
                            (f.find(".dt-column-title").attr("role", "button"), f.attr("tabindex", 0));
                    });
            },
        },
        layout: {
            _: function (t, e, n) {
                ...
                V.each(n, function (t, e) {
                    ...
                    e.table && a.addClass("dt-layout-table"),
                        V("<div/>")
                            .attr({ id: e.id || null, class: "dt-layout-cell " + t + (e.className || "") })
                            .append(e.contents)
                            .appendTo(a);
                });
            },
            ...
            function (t, s) {
                ...
                return t.oFeatures.bInfo
                    ? ((e = t.oLanguage),
                      ...
                      (s = V.extend({ callback: e.fnInfoCallback, empty: e.sInfoEmpty, postfix: e.sInfoPostFix, search: e.sInfoFiltered, text: e.sInfo }, s)),
                      ...
                      t._infoEl || (u.attr({ "aria-live": "polite", id: n + "_info", role: "status" }), V(t.nTable).attr("aria-describedby", n + "_info"), (t._infoEl = u)),
                      u)
                    : null;
            },
            "i"
    ...
    function Ne(t, e, n, a) {
        ...
        return (
            e <= n
                ...
                : ((r = h(t - o + i, t + o - l)).push("ellipsis"), r.unshift("ellipsis"), a && (r.push(e - 1), r.unshift(0))),
            r
        );
    }
    $.feature.register(
        ...
        function (n, t) {
            ...
            return n.oFeatures.bFilter
                ? ((e = n.oClasses.search),
                  ...
                  -1 === (t = V.extend({ placeholder: c.sSearchPlaceholder, text: c.sSearch }, t)).text.indexOf("_INPUT_") && (t.text += "_INPUT_"),
                  (t.text = ee(n, t.text)),
                  ...
                  (d = V("input", s)
                      ...
                      .on("keyup.DT search.DT input.DT paste.DT cut.DT", c ? $.util.debounce(u, c) : u)
        ...
        $.feature.register(
            ...
            function (t, e) {
                ...
                (e = V.extend({ buttons: $.ext.pager.numbers_length, type: t.sPaginationType, boundaryNumbers: !0 }, e)).numbers && (e.buttons = e.numbers);
                function n() {
                    !(function t(e, n, a) {
                        ...
                        for (var p = 0; p < f.length; p++) {
                            var g = f[p],
                                v = Fe(e, g, c, d),
                                m = te(e, "pagingButton")(e, g, v.display, v.active, v.disabled);
                            V(m.clicker).attr({
    ...
    return (
        $.feature.register(
            ...
            function (a, t) {
                ...
                else for (p = 0; p < r.length; p++) V.isPlainObject(r[p]) ? (o.push(r[p].value), i.push(r[p].label)) : (o.push(r[p]), i.push(r[p]));
                for (
                    var l = t.text.match(/_MENU_$/),
                        s = t.text.match(/^_MENU_/),
                        u = t.text.replace(/_MENU_/, ""),
                        t = "<label>" + t.text + "</label>",
                        c = (s ? (t = "_MENU_<label>" + u + "</label>") : l && (t = "<label>" + u + "</label>_MENU_"), V("<div/>").addClass(e.container).append(t.replace("_MENU_", "<span></span>"))),
                        d = [],
                        f =
                        ...
                        h = V("<select/>", { name: n + "_length", "aria-controls": n, class: e.select }),
                        p = 0;
                    p < o.length;
                    p++
                )
